...
class CsrGenerator
{
    ...
    protected function buildOpensslConfig(array $config): string
    {
        ...
        $environment = $config['environment'] ?? config('zatca.environment', 'sandbox');
        $templateName = in_array($environment, ['sandbox', 'simulation']) ? self::PRE_ZATCA_TEMPLATE_NAME : self::ZATCA_TEMPLATE_NAME;
